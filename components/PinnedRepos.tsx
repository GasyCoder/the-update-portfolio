      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="rounded-lg border border-slate-200/60 bg-white/70 p-4 dark:border-white/10 dark:bg-white/5"
            >
      ...
      {repositories.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {repositories.map((repo) => (
            <div
              key={repo.id}
              className="rounded-lg border border-slate-200/60 bg-white/80 p-4 transition-all hover:-translate-y-0.5 hover:border-indigo-200 dark:border-white/10 dark:bg-white/5 dark:hover:border-indigo-500/30"
            >

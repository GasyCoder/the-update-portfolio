...
export default function GitHubSidebar({ isLoading }: GitHubSidebarProps) {
  ...
  return (
    <aside className="w-full lg:w-72 flex-shrink-0">
      <div className="sticky top-20 space-y-6 rounded-xl border border-slate-200/70 bg-white/80 p-6 backdrop-blur-xl transition-colors duration-200 dark:border-white/10 dark:bg-white/5">
        {/* Profile Photo */}
        ...
        <div>
          ...
          <div className="flex gap-2 justify-center">
            <div className="group relative">
              <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center text-xl transition-all duration-200 hover:scale-105 cursor-pointer">
                🚀
              </div>
            ...
            <div className="group relative">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center text-xl transition-all duration-200 hover:scale-105 cursor-pointer">
                ⭐
              </div>
              <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-slate-900/90 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                Star Creator
            ...
            <div className="group relative">
              <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg flex items-center justify-center text-xl transition-all duration-200 hover:scale-105 cursor-pointer">
                🔥
              </div>
              <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-slate-900/90 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                Hot Streak
